    ...
    <div class="container py-5">
        <div class="row align-items-center">
            <div class="col-lg-7 mb-5 mb-lg-0">
                <div class="mb-4">
                    <h5 class="text-danger text-uppercase mb-3" style="letter-spacing: 5px;">Enroll in This </h5>
                    <h1 class="text-white">We Always Welcome for New Student!</h1>
                </div>
                <p class="text-white text-justify">At GMC, we offer a wide range of enriching courses . Whether you're looking to
                    enhance your skills, dive into a new subject, or simply
                    pursue a passion, we've got you covered!r</p>
                <ul class="list-inline text-white m-0">
                    <li class="py-2"><i class="fa fa-check text-danger mr-3"></i>
                ...
                <div class="card border-0">
                    ...
                    <div class="card-body rounded-bottom bg-primary p-5">
                        <form action="{{ route('frontend.contact-us.store') }}" method="POST">
                            ...
                            <div>
                                <button class="btn btn-danger btn-block border-0 py-3" type="submit">Submit
                                </button>
                            </div>
                        </form>
                    </div>
