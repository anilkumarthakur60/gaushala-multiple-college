...
@section('content')
    ...
    <div class="container py-5">
        ...
        <p>These Terms and Conditions ("Terms") govern your use of SKPS ("us", "we", or "our") website, [Your School
            Website URL] (the "Site"). By accessing or using the Site, you agree to be bound by these Terms. If you do
        ...
        <p>SKPS grants you a limited, non-exclusive, non-transferable, and revocable license to access and use the Site
            for personal and non-commercial purposes. You must not use the Site for any illegal or unauthorized purpose.
            You agree not to modify, copy, distribute, transmit, display, perform, reproduce, publish, license, create
            derivative works from, transfer, or sell any information, software, products, or services obtained from the
            Site.</p>

        <h3>Links to Third-Party Websites</h3>
        <p>The Site may contain links to third-party websites or services that are not owned or controlled by SKPS. We
            have no control over and assume no responsibility for the content, privacy policies, or practices of any
            third-party websites or services. You acknowledge and agree that SKPS shall not be responsible or liable,
        ...
        <h3>Termination</h3>
        <p>We may terminate or suspend your access to the Site immediately, without prior notice or liability, for any
