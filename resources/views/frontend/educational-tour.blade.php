...
@section('content')
    <x-bread-crumb-component title1="{{ $t1 = 'Educational Tour' }}" title2="{{ $t1 }}" />
        ...
        <div class="container">
            <div class="my-5">
                <div class="my-5">
                    ...
                    <p class="text-justify">
                        Our educational tours are carefully curated to be both enriching and enjoyable. They take
                        students
                        to a variety of destinations, from historical sites and museums to scientific institutions and
                        cultural landmarks. These trips offer students the opportunity to connect with their studies in
                        a
                        tangible way, helping them to see the relevance and application of what they learn in class.
                    </p>
                    <p class="text-justify">
                        During these tours, students not only gain knowledge but also develop essential life skills such
                        as
                        problem-solving, teamwork, and cultural sensitivity. They have the chance to interact with
                        experts
                    ...
                    <p class="text-justify">
                        ...
                        Safety and supervision are our top priorities, and our experienced staff ensure that every
                        student
                        is well-cared for throughout the trip. We also encourage open discussions and reflections on the
                        experiences, allowing students to process what they've learned and how it applies to their
                        education
                        and personal growth.
                    ...
                    <p class="text-justify">
                        ...
                        Our educational tours are more than just excursions; they are opportunities for students to
                        broaden
                        their horizons, gain a deeper understanding of the world around them, and foster a lifelong love
                        for
