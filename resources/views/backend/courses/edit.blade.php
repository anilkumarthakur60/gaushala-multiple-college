                ...
                <div class="card-body">
                    ...
                    <form action="{{route('courses.update',$course->slug)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <img id="imagePreview"
                                     src="{{asset($course->firstMedia('blogImage')?->getUrl())}}"
                                     alt=""
                            ...
                            <div class="form-floating col-6 mb-3">
                                <x-required-component type="text" required="required" names="name" value="{{$course->name}}" placeholder="Name"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <select class="form-control multiselect-tag" id="tags" name="tags[]" multiple="multiple">
                                    @foreach($course->tags as $tag)
                                        <option value="{{$tag->name}}"  {{$course->hasTag($tag->name)?'selected':''}} >{{$tag->name}}</option>
                                    @endforeach
                                </select>
