        ...
        <div class="container-fluid content-inner py-0">
            <div class="card pb-4">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('courses.index') }}" class="btn btn-primary">Go Back</a>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('courses.update', $course->slug) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <img id="imagePreview" src="{{ asset($course->firstMedia('blogImage')?->getUrl()) }}"
                            ...
                            <div class="form-floating col-6 mb-3">
                                <x-required-component type="text" required="required" names="name"
                                    value="{{ $course->name }}" placeholder="Name" classes="form-control">Name
                            ...
                            <div class="col-12 my-2">
                                ...
                                <textarea name="description" id="description" required cols="30" rows="10">{!! $course->description !!}</textarea>
                                ...
                                <select class="form-control multiselect-tag" id="tags" name="tags[]"
                                    ...
                                    @foreach ($course->tags as $tag)
                                        <option value="{{ $tag->name }}"
                                            {{ $course->hasTag($tag->name) ? 'selected' : '' }}>{{ $tag->name }}
                                        </option>
                                    @endforeach
                                </select>
